...
const TOP_ANCHOR = "ÉNERGIE MENSUELLE ESTIMÉE";
// Légende de bas de graphique partagée avec le graphique annuel de la page 2
// (même gabarit de rapport SolarEdge Designer). Sans accent sur le "E" : le
// PDF source lui-même l'omet ("Energie solaire écrêtée...").
const BOTTOM_ANCHOR = "Energie solaire";
const PADDING = 12;
...
/**
 * Localise la zone du graphique "ÉNERGIE MENSUELLE ESTIMÉE" (page 3 du
 * rapport SolarEdge, scénario avec stockage), en repérant le texte-ancre du
 * titre et celui de la légende de bas de page, puis en englobant tout le
 * contenu textuel compris entre les deux. Ne dépend d'aucune coordonnée
 * fixe : si la mise en page bouge légèrement (mais garde les mêmes
 * libellés), la zone suit.
 */
export async function findMonthlyEnergyChartBounds(
  page: PDFPageProxy,
): Promise<Bounds> {
